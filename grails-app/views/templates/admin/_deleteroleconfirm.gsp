...
<div id="deleteconfirm">
  <div class="deletepopup">
    <div class="banner"><strong><span class="icon icon_exclamation">&nbsp;</span><strong>Delete this role?</strong></strong></div>
    <div class="content">
      Deleting roles removes rights from many users and may cause access problems.
